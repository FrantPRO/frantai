...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_profile_basics_id'), 'profile_basics', ['id'], unique=False)
    ...
    op.create_table('chat_sessions',
        ...
        sa.Column('first_message_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    ...
    op.create_index('idx_chunks_source', 'knowledge_chunks', ['source_table', 'source_id'], unique=False)
    ...
    op.create_index(op.f('ix_knowledge_chunks_source_table'), 'knowledge_chunks', ['source_table'], unique=False)


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(op.f('ix_knowledge_chunks_source_table'), table_name='knowledge_chunks')
